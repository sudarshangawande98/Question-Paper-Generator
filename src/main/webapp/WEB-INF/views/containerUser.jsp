				...
				<div class="col-lg-8 mb-4 order-0">
					<div class="card">
						<div class="d-flex align-items-end row">
							<div class="col-sm-7">
								<div class="card-body">
									<h3 class="card-title text-primary">Welcome To QBank.....Faculty!</h3>
									<p class="fw-bold">
										<span class="fw-bold" style="color: black;"> Power Of Knowlege,knowlege of Power</span><br> <br> 
												The Aim of the this projects is to impact "Power Of Knowlege" and "knowlege
											    of Power" to the youth
									</p>
								</div>
							</div>
								...
								<div class="card-body">
									<div class="card-title d-flex align-items-start justify-content-between">
										<div class="avatar flex-shrink-0">
											<a href="/testmetadata"> <img
												src="../assets/img/icons/unicons/pencil.png"
								...
								<div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
									...
									<div class="carousel-inner">
										<div class="carousel-item active">
											<img class="d-block w-100" src="../assets/img/elements/b.png"
										...
										<div class="carousel-item">
											<img class="d-block w-100"
												src="../assets/img/elements/bms.png" alt="Third slide" height="400" />
											<div class="carousel-caption d-none d-md-block">
												<h3>
													<b>Mission</b>
												</h3>
							...
							<div class="card">
								<div class="card-body">
									<div class="card-title d-flex align-items-start justify-content-between">
										<div class="avatar flex-shrink-0">
											<a href="#"> <img
												src="../assets/img/icons/unicons/book.png" alt="Credit Card"
												class="rounded" />
											</a>
										</div>
									</div>
